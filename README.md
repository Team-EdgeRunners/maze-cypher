...
| ToF 1 XSHUT | \*\*GP10\*\* | For assigning unique I2C addresses |

| ToF 2 XSHUT | \*\*GP11\*\* | For assigning unique I2C addresses |

| ToF 3 XSHUT | \*\*GP12\*\* | For assigning unique I2C addresses |



\### L298N Motor Driver

| L298N Pin | Pico Pin | Notes |

| :--- | :--- | :--- |

| IN1 | \*\*GP19\*\* | Motor Direction |

| IN2 | \*\*GP18\*\* | Motor Direction |

| EN A | \*\*GP21\*\* | PWM Speed Control (Jumper Removed!) |

| EN B | \*\*GP20\*\* | PWM Speed Control (Optional for Motor 2) |

| Logic VSS | \*\*L7805CV\*\* | Powered safely by the 5V Regulator output |



\### N20 Motor Encoder

| Encoder Pin | Pico Pin | Notes |

| :--- | :--- | :--- |

| VCC | \*\*3V3(OUT)\*\* | Must be 3.3V to protect Pico logic pins! |

| GND | \*\*GND\*\* | Shared common ground |

| C1 | \*\*GP26\*\* | Hardware Interrupt (Counts ticks) |

| C2 | \*\*GP27\*\* | Direction tracking |
...
&#x20;  \* \*\*Adafruit\_VL53L0X\*\* (for the ToF sensors)
